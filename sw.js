const CACHE_NAME = 'mooreprint-v28';
const APP_SHELL = [
  ...
  './app-tools.js', './advanced-fixes.js', './advanced-features.js', './performance-fixes.js', './team-workflow.js', './state-bridge.js', './granular-sync-guard.js', './team-improvements.js', './startup-query-limit.js', './select-innerhtml-stability.js', './team-operations.js', './team-operations-ui-guard.js', './team-hardening.js', './supplier-catalog.js', './monthly-overhead.js', './branch-access.js', './catalog-cloud.js', './overhead-cloud.js', './usability.js', './mobile-fixes.js', './supabase-config.js', './supabase-cloud.js',
